                  ...
                  <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative group">
                        <FaDollarSign className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#E41E26] text-sm transition-all duration-300 group-focus-within:scale-110" />
                        <input
                          type="number"
                          name="BasePrice"
